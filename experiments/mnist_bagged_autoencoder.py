...
save_dir         = 'bagged_ae/snapshots'
debug_dir        = 'bagged_ae/debug'
snapshot_restore = 'bagged_ae/snapshots/deepset.ckpt-{}'.format(step_start)
...
with tf.Session(config=config) as sess:
    model = tfmodels.ImageBagAutoencoder(
