...
class ResNet(SegmentationBaseModel):
    ...
    def model(self, x_in, keep_prob=0.5, reuse=False, training=True):
        ...
        with tf.variable_scope(self.name) as scope:
            ...
            r0_0 = nonlin(conv(p0_pool, self.conv_kernels[0], stride=1, k_size=self.k_size, var_scope='r0_0', selu=1))
            r0_1 = conv(r0_0, self.conv_kernels[0], stride=1, k_size=self.k_size, var_scope='r0_1', selu=1)
            r0 = nonlin(p0_pool + r0_1)
            ...
            r1_0 = nonlin(conv(r0, self.conv_kernels[1], stride=2, k_size=self.k_size, var_scope='r1_0', selu=1))
            r1_1 = conv(r1_0, self.conv_kernels[1], stride=1, k_size=self.k_size, var_scope='r1_1', selu=1)
            r1 = nonlin(r0_residual + r1_1)
            ...
            r2_0 = nonlin(conv(r1, self.conv_kernels[2], stride=2, k_size=self.k_size, var_scope='r2_0', selu=1))
            r2_1 = conv(r2_0, self.conv_kernels[2], stride=1, k_size=self.k_size, var_scope='r2_1', selu=1)
            r2 = nonlin(r1_residual + r2_1)
            ...
            d2_0 = nonlin(deconv(r2, self.deconv_kernels[2], upsample_rate=2, k_size=self.k_size, var_scope='d2_0', selu=1))
            d2_1 = conv(d2_0, self.deconv_kernels[2], stride=1, k_size=self.k_size, var_scope='d2_1', selu=1)
            d2 = nonlin(r2_residual + d2_1)
            ...
            d1_0 = nonlin(deconv(d2, self.deconv_kernels[1], upsample_rate=2, k_size=self.k_size, var_scope='d1_0', selu=1))
            d1_1 = conv(d1_0, self.deconv_kernels[1], stride=1, k_size=self.k_size, var_scope='d1_1', selu=1)
            d1 = nonlin(d2_residual + d1_1)
            ...
            d0_0 = nonlin(deconv(d1, self.deconv_kernels[0], upsample_rate=2, k_size=self.k_size, var_scope='d0_0', selu=1))
            d0_1 = conv(d0_0, self.deconv_kernels[0], stride=1, k_size=self.k_size, var_scope='d0_1', selu=1)
            d0 = nonlin(d1_residual + d0_1)
