...
"""
class IntermediateNet(SegmentationBaseModel):
    base_defaults={
    ...
    def __init__(self, **kwargs):
        ...
        super(IntermediateNet, self).__init__(**self.base_defaults)
...
class IntermediateNetTraining(IntermediateNet):
    train_defaults = { 'mode': 'TRAIN' }

    def __init__(self, **kwargs):
        self.train_defaults.update(**kwargs)
        super(IntermediateNetTraining, self).__init__(**self.train_defaults)


class IntermediateNetInference(IntermediateNet):
    inference_defaults = { 'mode': 'TEST' }

    def __init__(self, **kwargs):
        self.inference_defaults.update(**kwargs)
        super(IntermediateNetInference, self).__init__(**self.inference_defaults)
